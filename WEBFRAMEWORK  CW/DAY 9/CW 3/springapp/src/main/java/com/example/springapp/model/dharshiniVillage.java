...
public class dharshiniVillage {
    ...
    public dharshiniVillage(){}
    public dharshiniVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
