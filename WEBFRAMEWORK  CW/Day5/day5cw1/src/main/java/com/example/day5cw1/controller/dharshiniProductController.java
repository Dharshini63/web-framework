...
public class dharshiniProductController {
    ...
    public ResponseEntity<dharshiniProduct> putMethodName(@PathVariable("productId") int id, @RequestBody dharshiniProduct product) {
    ...
    public ResponseEntity<dharshiniProduct> delete(@PathVariable("productId") int id,@RequestBody dharshiniProduct product)
    {
