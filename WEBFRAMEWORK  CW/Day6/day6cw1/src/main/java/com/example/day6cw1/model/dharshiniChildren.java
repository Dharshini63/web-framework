...
@Entity
public class dharshiniChildren {
    @Id
    private int babyId;
    ...
    public dharshiniChildren() {
    }
    public dharshiniChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
